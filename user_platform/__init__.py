"""Optional upstream compatibility services (data service only).
...
service reaches it only over HTTP through :mod:`user_platform.node_client`.
"""
...
async def init() -> bool:
    ...
    try:
        ...
        try:
            ...
            logger.exception("[user-platform] built-in SOP provisioning failed")
        ...
        _initialized = True
        logger.info("[user-platform] initialized")
        return True
    except Exception:
        logger.exception("[user-platform] initialization failed; main service continues")
        return False
...
def mount_routes(app) -> bool:
    ...
    try:
        ...
        from .routes_notify_devices import router as notify_devices_router
        ...
        from .routes_github_recognize import router as github_recognize_router
        ...
        app.include_router(notify_devices_router)
        ...
        app.include_router(github_recognize_router)
        ...
        try:
            ...
            logger.exception("[user-platform] remote node proxy setup failed")
        ...
        try:
            ...
            logger.exception("[user-platform] follow proxy mount failed")

        logger.info("[user-platform] platform routes mounted")
        return True
    except Exception:
        logger.exception("[user-platform] route mount failed; main service continues")
        return False
