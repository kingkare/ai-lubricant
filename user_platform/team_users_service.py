...
Backs the upstream team-admin surface (``/api/v1/teams/*``) for platform
...
logger = logging.getLogger("user_platform.audit")
    ...
    async def record_audit(
        ...
        *,
        ...
        try:
            ...
            logger.exception("[user-platform] audit write failed: %s", operation)
        ...
        *,
        ...
        if target_user is None:
            try:
                ...
                logger.exception("[user-platform] operation_logs merge failed")
